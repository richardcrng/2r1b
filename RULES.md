...
> 🇩🇪 *Two Rooms and a Boom* has official rules that only exist in German - so my understanding of the game is significantly indebted to [this unofficial English translation](https://boardgamegeek.com/filepage/139993/tempel-des-schreckens-unofficial-rules-english) of the rules.

**Welcome to the *Two Rooms and a Boom*!**

<img alt="Two Rooms and a Boom box art" src="./client/public/assets/tds-box.png" width="250" />
...
In *Two Rooms and a Boom*, **roles are always secret**. You know your role, but you don't know anybody else's role - and so you don't know who is, or who is not, on your team.
...
The *Two Rooms and a Boom* is organised into distinct Chambers, each of which is represented by a **Chamber card**.
...
<div style="display: flex; justify-content: space-around;">
  <div style="width: 150">
    <img alt="Two Rooms and a Boom - unopened chamber" src="./client/public/assets/tds-chamber.jpeg" width="150" />
    <p>Unknown chamber (unopened, back)</p>
  </div>
  <div style="width: 150">
    <img alt="Two Rooms and a Boom - gold chamber" src="./client/public/assets/tds-gold.jpeg" width="150" />
    <p>Gold chamber (opened, front)</p>
  </div>
  <div style="width: 150">
    <img alt="Two Rooms and a Boom - fire chamber" src="./client/public/assets/tds-fire.jpeg" width="150" />
    <p>Fire chamber (opened, front)</p>
  </div>
  <div style="width: 150">
    <img alt="Two Rooms and a Boom - empty chamber" src="./client/public/assets/tds-empty.jpeg" width="150" />
